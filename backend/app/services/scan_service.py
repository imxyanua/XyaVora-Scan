...
from app.schemas.report import (
    ...
    HttpOverviewResult, PageMetadataResult,
...
async def run_scan(
    ...
    async def _pipeline() -> ScanReport:
        dns_r, ssl_r, headers_r, http_r, meta_r, whois_r, tech_r, cookies_r, sectxt_r, shot_r = (
        ...
        all_findings = [
            f
            for result in (dns_r, ssl_r, headers_r, http_r, meta_r, whois_r, tech_r, cookies_r, sectxt_r, shot_r)
